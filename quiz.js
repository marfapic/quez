...
var questions = [
    ...
    {
      text: "Какой гормон помешает оргазму",
      answers: ["Эндорфин", "Кортизол", "Тестостерон", "Сератанин"],
      explanation: "question 2 explanation",
      explanationImage: "tiles/tiles-02.jpg",
      correctAnswerIndex: 3,
    },
    {
      text: "какие продукты питания помогут повысить либидо?",
      answers: ["устрицы", "авокадо", "никакие", "имбирь"],
